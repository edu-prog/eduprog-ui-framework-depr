<template>
  <div class="modal">
        ...
        >
          <div class="modal-header">
            <slot name="modal-header">
              <div v-if="!IsMobile" class="modal-header-btn">
              ...
              <div v-else class="modal-header-btn">
    ...
    <div class="modal-mobile" v-else>
      <BottomNavbar ref="bottom_navbar">
        <slot name="modal-content"></slot>
      </BottomNavbar>
    </div>
  </div>
